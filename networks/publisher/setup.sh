...
${cli} gov submit-list-proposal --chain-id ${chain_id} --from zc --deposit 200000000000:CE --base-asset-symbol ${nnb_symbol} --quote-asset-symbol CE --init-price 1000000000 --title "list NNB/CE" --description "list NNB/CE" --expire-time ${expire_time} --voting-period 5 --json
sleep 2
