...
func BenchmarkGetAccount(b *testing.B) {
	...
	acc.SetCoins(sdk.Coins{sdk.NewCoin("CE", 1000), sdk.NewCoin("BTC", 1000), sdk.NewCoin("ETH", 100)})
	acc.SetLockedCoins(sdk.Coins{sdk.NewCoin("CE", 1000), sdk.NewCoin("BTC", 1000), sdk.NewCoin("ETH", 100)})
	acc.SetFrozenCoins(sdk.Coins{sdk.NewCoin("CE", 1000), sdk.NewCoin("BTC", 1000), sdk.NewCoin("ETH", 100)})
